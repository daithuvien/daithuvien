...
function dtv_encrypt($textToEncrypt, $base64Key) {
...
function dtv_decrypt($base64IvCiphertext, $base64Key) {
...
$KEY = 'qVFq703K83fgmzbikUQZtxkDLB1jXfPFXmqYmQNupTo=';

function encode($text) {
    global $KEY;
    return dtv_encrypt($text, $KEY);
}

function decode($encoded) {
    global $KEY;
    return dtv_decrypt($encoded, $KEY);
}
